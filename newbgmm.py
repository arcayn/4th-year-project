# this file is a modification of the scikit-learn Bayesian GMM which allows non-uniform
# Dirichlet concentration priors for experiments I ran but did not end up in the final report
